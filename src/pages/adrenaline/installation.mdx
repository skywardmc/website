...
If you want to install Adrenaline, we recommend following [Modrinth's documentation](https://support.modrinth.com/en/articles/8802250-modpacks-on-modrinth). You'll need to install a third-party Minecraft launcher that supports Modrinth modpacks, such as [Modrinth App](https://modrinth.com/app) or [Prism Launcher](https://prismlauncher.org).

_We have an installer for the first-party Minecraft launcher, but we've delisted it due to new Modrinth API incompatibilities and we'll be working on an update soon to fix that in the future!_
