...
This may also work similarly on other handhelds, but the recommended one to use is the Steam Deck. First we'll install Prism Launcher, and then install the modpack.
